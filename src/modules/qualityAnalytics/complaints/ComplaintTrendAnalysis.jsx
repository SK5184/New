...
export default function ComplaintTrendAnalysis() {
  return (
    <div style={S.card}>
      <h3 style={S.title}>6-Month Complaint Trend</h3>
      <p style={S.subtitle}>Consolidated complaint volume timeline</p>
      
      <div style={{ marginTop: 24, textAlign: "center" }}>
        <div style={{ fontSize: 28, fontWeight: 700, color: "#0D9488" }}>0.08%</div>
        <div style={{ fontSize: 11, color: "#64748B", marginTop: 4 }}>Average monthly complaint rate</div>
      </div>
    </div>
  );
}