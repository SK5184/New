...
export default function ComplaintCategoryAnalysis() {
  return (
    <div style={S.card}>
      <h3 style={S.title}>Complaint category distribution</h3>
      <p style={S.subtitle}>Categorization of complaints logged</p>
      
      <div style={{ marginTop: 20 }}>
        <div style={{ display: "flex", justifyContent: "space-between", borderBottom: "1px solid #F1F5F9", padding: "8px 0" }}>
          <span>Report Turnaround Time (TAT)</span>
          <span style={{ fontWeight: "bold" }}>4 cases</span>
        </div>
        <div style={{ display: "flex", justifyContent: "space-between", borderBottom: "1px solid #F1F5F9", padding: "8px 0" }}>
          <span>Phlebotomy pain / behavior</span>
          <span style={{ fontWeight: "bold" }}>1 case</span>
        </div>
        <div style={{ display: "flex", justifyContent: "space-between", padding: "8px 0" }}>
          <span>Online Report download issue</span>
