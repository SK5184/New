...
import ComplaintTrendAnalysis from "./ComplaintTrendAnalysis";
import ComplaintCategoryAnalysis from "./ComplaintCategoryAnalysis";
...
export default function ComplaintDashboard() {
  return (
    <div style={S.wrap}>
      <div style={S.header}>
        <div>
          <h2 style={S.title}>Customer complaints analytics</h2>
          <div style={S.subtitle}>ISO 15189:2022 §7.7.12 · Feedback, complaints, and satisfaction index</div>
        </div>
      </div>

      <div style={S.grid(2)}>
        <ComplaintTrendAnalysis />
        <ComplaintCategoryAnalysis />
      </div>
    </div>
  );
}