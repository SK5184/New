...
import CAPAEffectiveness from "./CAPAEffectiveness";
import CAPAClosureAnalysis from "./CAPAClosureAnalysis";
import OverdueCAPA from "./OverdueCAPA";
...
export default function CAPADashboard() {
  return (
    <div style={S.wrap}>
      <div style={S.header}>
        <div>
          <h2 style={S.title}>CAPA Effectiveness & Closure Analytics</h2>
          <div style={S.subtitle}>ISO 15189:2022 §8.7 · Corrective Actions monitoring dashboard</div>
        </div>
      </div>
