...
export default function CAPAClosureAnalysis() {
  return (
    <div style={S.card}>
      <h3 style={S.title}>CAPA Closure rate & duration</h3>
      <p style={S.subtitle}>Consolidated resolution velocity metrics</p>
      
      <div style={{ marginTop: 24, display: "flex", justifyContent: "space-around" }}>
        <div style={{ textAlign: "center" }}>
          <div style={{ fontSize: 28, fontWeight: 700, color: "#0D9488" }}>92.4%</div>
          <div style={{ fontSize: 11, color: "#64748B", marginTop: 4 }}>Closure Rate</div>
        </div>
        <div style={{ borderLeft: "1px solid #E2E8F0", height: 50 }} />
        <div style={{ textAlign: "center" }}>
          <div style={{ fontSize: 28, fontWeight: 700, color: "#0F172A" }}>14.2 days</div>
          <div style={{ fontSize: 11, color: "#64748B", marginTop: 4 }}>Avg Resolution Time</div>
        </div>
      </div>
    </div>
  );
