...
export default function AcknowledgementCompliance() {
  return (
    <div style={S.card}>
      <h3 style={S.title}>SOP Acknowledgement compliance</h3>
      <p style={S.subtitle}>Percent of department staff acknowledging new version releases</p>
      
      <div style={{ marginTop: 24, textAlign: "center" }}>
        <div style={{ fontSize: 28, fontWeight: 700, color: "#0D9488" }}>98.2%</div>
        <div style={{ fontSize: 11, color: "#64748B", marginTop: 4 }}>Staff acknowledgment compliance rate</div>
      </div>
    </div>
  );
}