...
export default function RevisionAnalysis() {
  return (
    <div style={S.card}>
      <h3 style={S.title}>Document Approval cycle time</h3>
      <p style={S.subtitle}>Average days required from draft creation to HOD signature approval</p>
      
      <div style={{ marginTop: 24, textAlign: "center" }}>
        <div style={{ fontSize: 28, fontWeight: 700, color: "#0D9488" }}>6.40 days</div>
        <div style={{ fontSize: 11, color: "#64748B", marginTop: 4 }}>Average approval turnaround speed</div>
      </div>
    </div>
  );
}