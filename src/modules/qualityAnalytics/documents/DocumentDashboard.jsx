...
import AcknowledgementCompliance from "./AcknowledgementCompliance";
...
export default function DocumentDashboard() {
  return (
    <div style={S.wrap}>
      <div style={S.header}>
        <div>
          <h2 style={S.title}>SOP Control & Revision analysis</h2>
          <div style={S.subtitle}>ISO 15189:2022 §8.2–8.4 · Document control velocity</div>
        </div>
      </div>

      <div style={S.grid(2)}>
        <RevisionAnalysis />
        <AcknowledgementCompliance />
      </div>
    </div>
  );
}