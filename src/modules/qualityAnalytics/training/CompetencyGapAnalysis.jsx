...
export default function CompetencyGapAnalysis() {
  return (
    <div style={S.card}>
      <h3 style={S.title}>Personnel Competency Gaps</h3>
      <p style={S.subtitle}>Overdue competency evaluations</p>
      
      <div style={{ marginTop: 20 }}>
        <div style={{ display: "flex", justifyContent: "space-between", borderBottom: "1px solid #F1F5F9", padding: "8px 0" }}>
          <span>Sarah Jenkins (Pipetting proficiency)</span>
          <span style={{ color: "#EF4444", fontWeight: 600 }}>Overdue</span>
        </div>
        <div style={{ display: "flex", justifyContent: "space-between", padding: "8px 0" }}>
          <span>Alex Mercer (Vitek operational sign-off)</span>
          <span style={{ color: "#0D9488", fontWeight: 600 }}>Certified</span>
        </div>
      </div>
    </div>
  );
