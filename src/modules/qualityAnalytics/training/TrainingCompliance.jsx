...
export default function TrainingCompliance() {
  return (
    <div style={S.card}>
      <h3 style={S.title}>Staff Training CME compliance</h3>
      <p style={S.subtitle}>Completed training hours vs yearly targets</p>
      
      <div style={{ marginTop: 24, textAlign: "center" }}>
        <div style={{ fontSize: 28, fontWeight: 700, color: "#0D9488" }}>94.2%</div>
        <div style={{ fontSize: 11, color: "#64748B", marginTop: 4 }}>CME completion compliance score</div>
      </div>
    </div>
  );
}