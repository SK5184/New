...
import StockoutPrediction from "./StockoutPrediction";
import QCFailurePrediction from "./QCFailurePrediction";
...
export default function RiskPrediction() {
  return (
    <div style={S.wrap}>
      <div style={S.header}>
        <div>
          <h2 style={S.title}>Predictive Analytics & Drift alerts</h2>
          <div style={S.subtitle}>Consolidating consumption, control drift, and risk hot spots</div>
        </div>
      </div>
