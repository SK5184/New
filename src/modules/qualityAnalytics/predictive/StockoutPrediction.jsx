...
export default function StockoutPrediction() {
  return (
    <div style={S.card}>
      <h3 style={S.title}>Reagent Stockout forecast</h3>
      <p style={S.subtitle}>Predictive stockouts based on consumption velocity</p>
      
      <div style={{ marginTop: 20 }}>
        <div style={{ display: "flex", justifyContent: "space-between", borderBottom: "1px solid #F1F5F9", padding: "8px 0" }}>
          <span>Glucose Control Reagent (Level 2)</span>
          <span style={{ color: "#EF4444", fontWeight: "bold" }}>In 4 days</span>
        </div>
        <div style={{ display: "flex", justifyContent: "space-between", borderBottom: "1px solid #F1F5F9", padding: "8px 0" }}>
          <span>EDTA Blood Containers</span>
          <span>In 14 days</span>
        </div>
        <div style={{ display: "flex", justifyContent: "space-between", padding: "8px 0" }}>
          <span>Vitek Card Consumables</span>
          <span>In 32 days</span>
        </div>
      </div>
    </div>
  );
