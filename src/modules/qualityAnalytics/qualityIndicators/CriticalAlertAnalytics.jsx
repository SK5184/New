...
export default function CriticalAlertAnalytics() {
  return (
    <div style={S.card}>
      <h3 style={S.title}>Critical Value Alerts Notification Compliance</h3>
      <p style={S.subtitle}>ISO 15189 §7.8.1.3 · Alert delivery times within 15 minutes limit</p>
      
      <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginTop: 20 }}>
        <div style={{ textAlign: "center", flex: 1 }}>
          <div style={{ fontSize: 24, fontWeight: 700, color: "#0D9488" }}>98.5%</div>
          <div style={{ fontSize: 11, color: "#64748B", marginTop: 4 }}>Call Success Compliance</div>
        </div>
        <div style={{ borderLeft: "1px solid #CBD5E1", height: 50 }} />
        <div style={{ textAlign: "center", flex: 1 }}>
          <div style={{ fontSize: 24, fontWeight: 700, color: "#0F172A" }}>9.4 mins</div>
          <div style={{ fontSize: 11, color: "#64748B", marginTop: 4 }}>Average Response Time</div>
        </div>
      </div>
    </div>
  );
