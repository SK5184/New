...
export default function CorrectedReportAnalytics() {
  return (
    <div style={S.card}>
      <h3 style={S.title}>Post-Examination Report Amendments</h3>
      <p style={S.subtitle}>ISO 15189 §8.4.2 · Amended report counts by clinical section</p>
      
      <div style={{ marginTop: 20 }}>
        <div style={{ display: "flex", justifyContent: "space-between", borderBottom: "1px solid #F1F5F9", padding: "8px 0" }}>
          <span style={{ fontSize: 12 }}>Biochemistry</span>
          <span style={{ fontSize: 12, fontWeight: "bold" }}>3 cases</span>
        </div>
        <div style={{ display: "flex", justifyContent: "space-between", borderBottom: "1px solid #F1F5F9", padding: "8px 0" }}>
          <span style={{ fontSize: 12 }}>Microbiology</span>
          <span style={{ fontSize: 12, fontWeight: "bold" }}>1 case</span>
        </div>
        <div style={{ display: "flex", justifyContent: "space-between", padding: "8px 0" }}>
          <span style={{ fontSize: 12 }}>Haematology</span>
          <span style={{ fontSize: 12, fontWeight: "bold" }}>0 cases</span>
        </div>
      </div>
    </div>
  );
