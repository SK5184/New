...
import TATAnalytics from "./TATAnalytics";
import SampleRejectionAnalytics from "./SampleRejectionAnalytics";
import CriticalAlertAnalytics from "./CriticalAlertAnalytics";
import CorrectedReportAnalytics from "./CorrectedReportAnalytics";
import ComplaintRateAnalytics from "./ComplaintRateAnalytics";
...
export default function QualityIndicatorDashboard() {
  return (
    <div style={S.wrap}>
      <div style={S.header}>
        <div>
          <h2 style={S.title}>ISO 15189 Quality Indicators Dashboard</h2>
          <div style={S.subtitle}>ISO 15189:2022 §7.6 · Phase-wise Pre-exam, Exam & Post-exam Indicators</div>
        </div>
      </div>

      <div style={S.grid(2)}>
        <TATAnalytics />
        <SampleRejectionAnalytics />
      </div>

      <div style={S.grid(2)}>
        <CriticalAlertAnalytics />
        <CorrectedReportAnalytics />
      </div>
