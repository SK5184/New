...
export default function RiskTrendAnalysis() {
  return (
    <div style={S.card}>
      <h3 style={S.title}>Average Risk Index Trend</h3>
      <p style={S.subtitle}>Consolidated risk level history over past 6 months</p>
      
      <div style={{ marginTop: 24, textAlign: "center" }}>
        <div style={{ fontSize: 28, fontWeight: 700, color: "#0D9488" }}>8.40</div>
        <div style={{ fontSize: 11, color: "#64748B", marginTop: 4 }}>Medium Risk Range Average</div>
      </div>
    </div>
  );
}