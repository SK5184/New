...
import ResidualRiskAnalysis from "./ResidualRiskAnalysis";
...
export default function RiskDashboard() {
  return (
    <div style={S.wrap}>
      <div style={S.header}>
        <div>
          <h2 style={S.title}>Operational & Clinical Risk Matrix</h2>
          <div style={S.subtitle}>ISO 15189:2022 §5.6 & §8.5 · Risk Management and Mitigation metrics</div>
        </div>
      </div>
