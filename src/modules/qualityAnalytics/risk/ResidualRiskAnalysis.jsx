...
export default function ResidualRiskAnalysis() {
  return (
    <div style={S.card}>
      <h3 style={S.title}>Residual Risk Analysis</h3>
      <p style={S.subtitle}>Pre-mitigation risk severity vs post-mitigation residual severity</p>
      
      <div style={{ marginTop: 20 }}>
        <div style={{ display: "flex", justifyContent: "space-between", borderBottom: "1px solid #F1F5F9", padding: "8px 0" }}>
          <span>Cold Chain Failure (Initial)</span>
          <span style={{ fontWeight: "bold", color: "#EF4444" }}>16 (High)</span>
        </div>
        <div style={{ display: "flex", justifyContent: "space-between", borderBottom: "1px solid #F1F5F9", padding: "8px 0" }}>
          <span>Cold Chain Failure (Residual)</span>
          <span style={{ fontWeight: "bold", color: "#0D9488" }}>4 (Low)</span>
        </div>
        <div style={{ display: "flex", justifyContent: "space-between", padding: "8px 0" }}>
          <span>Mitigation Status</span>
          <span style={{ color: "#0D9488", fontWeight: 600 }}>Active Control</span>
        </div>
      </div>
    </div>
  );
