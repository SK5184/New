...
export default function NearMissAnalysis() {
  return (
    <div style={S.card}>
      <h3 style={S.title}>Proactive Near-Miss Log analysis</h3>
      <p style={S.subtitle}>Incidents caught prior to patient impact</p>
      
      <div style={{ marginTop: 24, textAlign: "center" }}>
        <div style={{ fontSize: 28, fontWeight: 700, color: "#0D9488" }}>4 cases</div>
        <div style={{ fontSize: 11, color: "#64748B", marginTop: 4 }}>Near misses identified and closed</div>
      </div>
    </div>
  );
}