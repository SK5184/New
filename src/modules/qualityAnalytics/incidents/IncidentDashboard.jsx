...
import AdverseIncidentAnalysis from "./AdverseIncidentAnalysis";
import NearMissAnalysis from "./NearMissAnalysis";
...
export default function IncidentDashboard() {
  return (
    <div style={S.wrap}>
      <div style={S.header}>
        <div>
          <h2 style={S.title}>Adverse Events & Near Miss Intelligence</h2>
          <div style={S.subtitle}>ISO 15189:2022 §7.10 · Patient safety & operational incidents</div>
        </div>
      </div>

      <div style={S.grid(2)}>
        <AdverseIncidentAnalysis />
        <NearMissAnalysis />
      </div>
    </div>
  );
