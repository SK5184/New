...
export default function ClauseWiseAuditAnalysis() {
  return (
    <div style={S.card}>
      <h3 style={S.title}>Clause-wise Finding distribution</h3>
      <p style={S.subtitle}>ISO 15189:2022 clause violations analysis</p>
      
      <div style={{ marginTop: 20 }}>
        <div style={{ display: "flex", justifyContent: "space-between", borderBottom: "1px solid #F1F5F9", padding: "8px 0" }}>
          <span>Clause 6.4 (Equipment calibration)</span>
          <span style={{ fontWeight: "bold" }}>2 cases</span>
        </div>
        <div style={{ display: "flex", justifyContent: "space-between", borderBottom: "1px solid #F1F5F9", padding: "8px 0" }}>
          <span>Clause 7.2 (Sample Transport)</span>
          <span style={{ fontWeight: "bold" }}>1 case</span>
        </div>
        <div style={{ display: "flex", justifyContent: "space-between", padding: "8px 0" }}>
          <span>Clause 8.3 (Document control version)</span>
