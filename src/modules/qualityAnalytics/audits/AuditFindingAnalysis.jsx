...
export default function AuditFindingAnalysis() {
  return (
    <div style={S.card}>
      <h3 style={S.title}>Audit Findings by Severity</h3>
      <p style={S.subtitle}>Categorization of findings logged in past audits</p>
      ...
      <div style={{ marginTop: 24, display: "flex", justifyContent: "space-around" }}>
        <div style={{ textAlign: "center" }}>
          ...
          <div style={{ fontSize: 11, color: "#64748B", marginTop: 4 }}>Major Findings</div>
        </div>
        <div style={{ borderLeft: "1px solid #E2E8F0", height: 50 }} />
        <div style={{ textAlign: "center" }}>
          <div style={{ fontSize: 24, fontWeight: 700, color: "#F59E0B" }}>2</div>
          <div style={{ fontSize: 11, color: "#64748B", marginTop: 4 }}>Minor Findings</div>
        </div>
        <div style={{ borderLeft: "1px solid #E2E8F0", height: 50 }} />
        <div style={{ textAlign: "center" }}>
          <div style={{ fontSize: 24, fontWeight: 700, color: "#3B82F6" }}>3</div>
          <div style={{ fontSize: 11, color: "#64748B", marginTop: 4 }}>Observations</div>
        </div>
      </div>
    </div>
  );
