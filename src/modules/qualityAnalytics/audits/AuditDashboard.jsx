...
import AuditFindingAnalysis from "./AuditFindingAnalysis";
import ClauseWiseAuditAnalysis from "./ClauseWiseAuditAnalysis";
import DepartmentWiseAuditAnalysis from "./DepartmentWiseAuditAnalysis";
...
export default function AuditDashboard() {
  return (
    <div style={S.wrap}>
      <div style={S.header}>
        <div>
          <h2 style={S.title}>Internal Audit findings & Compliance</h2>
          <div style={S.subtitle}>ISO 15189:2022 §8.8 · Continual Audit tracking dashboard</div>
        </div>
      </div>

      <div style={S.grid(2)}>
        <AuditFindingAnalysis />
        <ClauseWiseAuditAnalysis />
      </div>

      <div style={S.grid(1)}>
        <DepartmentWiseAuditAnalysis />
      </div>
    </div>
  );
}