...
import NCRTrendAnalysis from "./NCRTrendAnalysis";
import NCRCategoryAnalysis from "./NCRCategoryAnalysis";
import DepartmentWiseNCR from "./DepartmentWiseNCR";
import ClauseWiseNCR from "./ClauseWiseNCR";
...
export default function NCRDashboard() {
  return (
    <div style={S.wrap}>
      <div style={S.header}>
        <div>
          <h2 style={S.title}>Non-Conformity (NCR) Pareto & Clause Mapping</h2>
          <div style={S.subtitle}>ISO 15189:2022 §7.10 · Continual Improvement and Root Cause Intelligence</div>
        </div>
      </div>
