...
export default function DeliveryPerformance() {
  return (
    <div style={S.card}>
      <h3 style={S.title}>Delivery timelines & Lead times</h3>
      <p style={S.subtitle}>Consolidated supplier shipping velocities</p>
      
      <div style={{ marginTop: 24, textAlign: "center" }}>
        <div style={{ fontSize: 28, fontWeight: 700, color: "#0D9488" }}>4.2 days</div>
        <div style={{ fontSize: 11, color: "#64748B", marginTop: 4 }}>Average order-to-delivery lead time</div>
      </div>
    </div>
  );
}