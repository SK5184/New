...
import VendorScoreAnalysis from "./VendorScoreAnalysis";
...
export default function SupplierPerformanceDashboard() {
  return (
    <div style={S.wrap}>
      <div style={S.header}>
        <div>
          <h2 style={S.title}>Approved Suppliers Performance</h2>
          <div style={S.subtitle}>ISO 15189:2022 §6.7 · External provider evaluations</div>
        </div>
      </div>
