...
export default function DowntimeAnalysis() {
  return (
    <div style={S.card}>
      <h3 style={S.title}>Analyzer Uptime ratio (%)</h3>
      <p style={S.subtitle}>Comparing target uptime vs actual performance</p>
      
      <div style={{ marginTop: 20 }}>
        <div style={{ display: "flex", justifyContent: "space-between", fontSize: 12, marginBottom: 4 }}>
          <span style={{ fontWeight: 600 }}>Cobas c311 Analyzer</span>
          <span>99.2% (Target: &gt; 98%)</span>
        </div>
        <div style={{ height: 8, background: "#F1F5F9", borderRadius: 4, overflow: "hidden", marginBottom: 14 }}>
          <div style={{ width: "99.2%", height: "100%", background: "#0D9488" }} />
        </div>

        <div style={{ display: "flex", justifyContent: "space-between", fontSize: 12, marginBottom: 4 }}>
          <span style={{ fontWeight: 600 }}>Sysmex XN-1000</span>
          <span>98.6% (Target: &gt; 98%)</span>
        </div>
        <div style={{ height: 8, background: "#F1F5F9", borderRadius: 4, overflow: "hidden" }}>
          <div style={{ width: "98.6%", height: "100%", background: "#0D9488" }} />
        </div>
      </div>
    </div>
  );
