...
export default function BreakdownTrend() {
  return (
    <div style={S.card}>
      <h3 style={S.title}>Biomedical Breakdown Trends</h3>
      <p style={S.subtitle}>Total logged equipment breakdown counts</p>
      
      <div style={{ marginTop: 24, textAlign: "center" }}>
        <div style={{ fontSize: 28, fontWeight: 700, color: "#EF4444" }}>1 case</div>
        <div style={{ fontSize: 11, color: "#64748B", marginTop: 4 }}>Active breakdown ticket under repair</div>
      </div>
    </div>
  );
}