...
export default function ShiftAnalysis({ analyte }) {
  return (
    <div style={S.card}>
      <h3 style={S.title}>QC Run Shifts Analysis</h3>
      <p style={S.subtitle}>Detecting sudden mean shifts (e.g. calibration changes)</p>
      ...
      <div style={{ padding: "12px 16px", background: "#E6FDF5", borderRadius: 8, border: "0.5px solid #A7F3D0", display: "flex", gap: 10, alignItems: "center", marginTop: 14 }}>
        ...
        <span style={{ fontSize: 12, color: "#065F46" }}>Mean values remain centered. Zero shift alerts generated.</span>
      </div>
    </div>
  );
}