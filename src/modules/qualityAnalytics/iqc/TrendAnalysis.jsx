...
export default function TrendAnalysis({ analyte }) {
  return (
    <div style={S.card}>
      <h3 style={S.title}>QC Drift / Trend Detection Analytics</h3>
      <p style={S.subtitle}>Detecting systematic variations (e.g. lamp degradation)</p>
      
      <div style={{ padding: "12px 16px", background: "#E6FDF5", borderRadius: 8, border: "0.5px solid #A7F3D0", display: "flex", gap: 10, alignItems: "center", marginTop: 14 }}>
        <span style={{ fontSize: 18 }}>✓</span>
        <span style={{ fontSize: 12, color: "#065F46" }}>No systematic drift detected over the past 30 control runs.</span>
      </div>
    </div>
  );
}