...
export default function CVAnalysis({ analyte }) {
  return (
    <div style={S.card}>
      <h3 style={S.title}>Observed Coefficient of Variation (CV%)</h3>
      <p style={S.subtitle}>Analytical precision audit for {analyte}</p>
      
      <div style={{ marginTop: 20 }}>
        <div style={{ display: "flex", justifyContent: "space-between", borderBottom: "1px solid #F1F5F9", padding: "8px 0" }}>
          <span>Observed CV% (Level 2)</span>
          <span style={{ fontWeight: "bold" }}>1.80%</span>
        </div>
        <div style={{ display: "flex", justifyContent: "space-between", borderBottom: "1px solid #F1F5F9", padding: "8px 0" }}>
