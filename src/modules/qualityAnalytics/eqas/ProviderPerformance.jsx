...
export default function ProviderPerformance({ analyte }) {
  return (
    <div style={S.card}>
      <h3 style={S.title}>PT Program Provider evaluations</h3>
      <p style={S.subtitle}>Consolidated audit score across approved programs</p>
      
      <div style={{ marginTop: 20 }}>
        <div style={{ display: "flex", justifyContent: "space-between", borderBottom: "1px solid #F1F5F9", padding: "8px 0" }}>
          <span>CMC Vellore EQAS</span>
          <span style={{ fontWeight: "bold", color: "#0D9488" }}>100% Satisfactory</span>
        </div>
        <div style={{ display: "flex", justifyContent: "space-between", borderBottom: "1px solid #F1F5F9", padding: "8px 0" }}>
          <span>AIIMS EQAS Program</span>
          <span style={{ fontWeight: "bold", color: "#0D9488" }}>100% Satisfactory</span>
        </div>
        <div style={{ display: "flex", justifyContent: "space-between", padding: "8px 0" }}>
          <span>CAP Survey Programs</span>
          <span style={{ fontWeight: "bold", color: "#0D9488" }}>100% Satisfactory</span>
        </div>
      </div>
    </div>
