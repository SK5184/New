...
export default function PeerComparison({ analyte }) {
  return (
    <div style={S.card}>
      <h3 style={S.title}>Peer Group consensus comparison</h3>
      ...
      <div style={{ marginTop: 20 }}>
        <div style={{ display: "flex", justifyContent: "space-between", borderBottom: "1px solid #F1F5F9", padding: "8px 0" }}>
          <span>Your Lab Mean</span>
          <span style={{ fontWeight: "bold" }}>100.4 mg/dL</span>
        </div>
        <div style={{ display: "flex", justifyContent: "space-between", borderBottom: "1px solid #F1F5F9", padding: "8px 0" }}>
          <span>Peer Consensus Mean</span>
          <span>99.6 mg/dL</span>
        </div>
        <div style={{ display: "flex", justifyContent: "space-between", padding: "8px 0" }}>
          <span>Interlaboratory Method</span>
          <span>Spectrophotometry (Cobas c311)</span>
        </div>
      </div>
    </div>
  );
