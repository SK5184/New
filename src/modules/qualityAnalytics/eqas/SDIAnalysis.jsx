...
export default function SDIAnalysis({ analyte }) {
  return (
    <div style={S.card}>
      <h3 style={S.title}>Standard Deviation Index (SDI) per Survey</h3>
      <p style={S.subtitle}>Consensus statistics for analyte {analyte}</p>
      
      <div style={{ marginTop: 24, textAlign: "center" }}>
        <div style={{ fontSize: 32, fontWeight: 700, color: "#0D9488" }}>+0.42</div>
        <div style={{ fontSize: 12, color: "#64748B", marginTop: 6 }}>Target: -2.00 to +2.00 SDI</div>
        <div style={{ display: "inline-block", marginTop: 12, padding: "3px 10px", background: "#E6FDF5", border: "0.5px solid #A7F3D0", borderRadius: 12, fontSize: 11, color: "#065F46", fontWeight: "bold" }}>
          Excellent Consensus
        </div>
      </div>
    </div>
