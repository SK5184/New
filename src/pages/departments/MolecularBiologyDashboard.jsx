// Molecular BiologyDashboard.jsx
// ISO 15189:2022 & ISO 27001:2022 Compliant Molecular Biology Dashboard
...
export default function MolecularBiologyDashboard({ role, userName }) {
    ...
    <div style={S.wrap}>
      <div style={S.sidebar}>
        <div style={{ padding: "14px 16px", borderBottom: "0.5px solid #E0DDD6" }}>
          <div style={{ fontSize: 13, fontWeight: 600, color: "#065F46" }}>Molecular Biology</div>
      ...
      <div style={S.content}>
        {activeTab === "roster" && (
          <WeeklyDutyRoster department="Molecular Biology" role={role} userName={userName} />
        )}
      </div>
    </div>
  );
