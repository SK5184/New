// Call CentreDashboard.jsx
// ISO 15189:2022 & ISO 27001:2022 Compliant Call Centre Dashboard
...
export default function CallCentreDashboard({ role, userName }) {
    ...
    <div style={S.wrap}>
      <div style={S.sidebar}>
        <div style={{ padding: "14px 16px", borderBottom: "0.5px solid #E0DDD6" }}>
          <div style={{ fontSize: 13, fontWeight: 600, color: "#065F46" }}>Call Centre</div>
      ...
      <div style={S.content}>
        {activeTab === "roster" && (
          <WeeklyDutyRoster department="Call Centre" role={role} userName={userName} />
        )}
      </div>
    </div>
  );
