// Front OfficeDashboard.jsx
// ISO 15189:2022 & ISO 27001:2022 Compliant Front Office Dashboard
...
export default function FrontOfficeDashboard({ role, userName }) {
    ...
    <div style={S.wrap}>
      <div style={S.sidebar}>
        <div style={{ padding: "14px 16px", borderBottom: "0.5px solid #E0DDD6" }}>
          <div style={{ fontSize: 13, fontWeight: 600, color: "#065F46" }}>Front Office</div>
        ...
        <div style={S.navItem(activeTab === "rec_temp_monitoring")} onClick={() => setActiveTab("rec_temp_monitoring")}>
          <span>🌡️</span> <span>Temperature & Humidity Monitoring</span>
        </div>
      </div>
      <div style={S.content}>
        {activeTab === "roster" && (
          <WeeklyDutyRoster department="Front Office" role={role} userName={userName} />
        )}
        {activeTab === "rec_temp_monitoring" && (
          <TemperatureDashboard department="Front Office" />
        )}
      </div>
    </div>
  );
