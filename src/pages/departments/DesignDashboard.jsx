// DesignDashboard.jsx
// ISO 15189:2022 & ISO 27001:2022 Compliant Design Dashboard
...
export default function DesignDashboard({ role, userName }) {
    ...
    <div style={S.wrap}>
      <div style={S.sidebar}>
        <div style={{ padding: "14px 16px", borderBottom: "0.5px solid #E0DDD6" }}>
          <div style={{ fontSize: 13, fontWeight: 600, color: "#065F46" }}>Design</div>
      ...
      <div style={S.content}>
        {activeTab === "roster" && (
          <WeeklyDutyRoster department="Design" role={role} userName={userName} />
        )}
      </div>
    </div>
  );
